...
class VagaClass // aluno
{
    ...
    public function __construct($vaga = null)
    {
        ...
        $this->latitude           = $vaga["vaga_latitude"] ?? null;
        $this->longitude          = $vaga["vaga_longitude"] ?? null;
...
public function buscarVagaPorCodigo($codigo)
{

    return (new  VagaDAO())->buscarVagaPorCodigoDAO($codigo);
    ...
    public function cadastrarNovaVaga($dados)
    {
            ...
            $oVaga = new VagaClass();
                ...
                if (isset($dados['longitude'])) {
                    $oVaga->longitude = $dados['longitude'];
                } else {
                    $oVaga->longitude = null;
                }
