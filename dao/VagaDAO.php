...
//##############################################################################
    public function cadastrarNovaVagaDAO($oVaga) {
        ...
        try {
                ...
                (vaga_titulo, vaga_descricao, vaga_salario, vaga_quantidade, vaga_beneficios, vaga_horario, vaga_tipo_contratacao, vaga_empresa_fk) 
                VALUES 
                (:titulo, :descricao, :salario, :quantidade, :beneficios, :horario, :tipocontratacao, :empresa_fk);";
