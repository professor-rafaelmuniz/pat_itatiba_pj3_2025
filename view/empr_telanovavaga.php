                ...
                <form method="POST" action="<?php echo $this->getHash("Vaga=cadastrarNovaVaga") ?>" onsubmit="return validarFormulario()" enctype="multipart/form-data">
                    <div class="card mb-4" style="padding:10px;">
                        <div class="col-xl-12 col-md-12">
                            ...
                            <div class="row">
                                <div class="card-body col-md-5">
                                    <label for="fonte">Latitude</label>
                                    <input type="text" class="form-control" name="latitude" id="latitude" maxlength="20" required>
                                    <label for="fonte">Longitude</label>
                                    <input type="text" class="form-control" name="longitude" id="longitude" maxlength="20" required>
                                </div>
                            </div>
